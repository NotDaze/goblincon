...
class DrawPad extends react_1.default.Component {
    ...
    Color(props) {
        ...
        return (react_1.default.createElement("button", { className: "color-button", style: unselectedStyle, onClick: onClick }));
    }
    ColorContainer() {
        const Color = this.Color.bind(this);
        return (react_1.default.createElement("div", { id: "drawpad-color-container", className: "flex" }, colors.map(color => react_1.default.createElement(Color, { key: color, color: color }))));
    }
    canvasSetup() {
        if (!this.canvas)
            return;
    ...
    Canvas() {
        ...
        const canvasComponent = (react_1.default.createElement("canvas", { ref: canvasRef, id: "drawpad-canvas", width: "360px", height: "360px", onMouseDown: canvasStartDraw, onMouseMove: canvasDraw, onMouseUp: canvasEndDraw, onMouseLeave: canvasEndDraw }, "You don't have canvas support!"));
        return canvasComponent;
    }
    render() {
        const ColorContainer = this.ColorContainer.bind(this);
        const Canvas = this.Canvas.bind(this);
        return (react_1.default.createElement("div", { id: "drawpad", className: "flex" },
