...
const canvas_1 = __importDefault(require("./Client/Rendering/canvas"));
class CanvasDrawPad {
    canvas;
    source = canvas_1.default.create();
    isDrawing = false;
    constructor(canvas, sourceWidth = canvas.width, sourceHeight = sourceWidth) {
        this.canvas = canvas;
